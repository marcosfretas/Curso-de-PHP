        ...
        <div class="conteudo">
            <nav class="modulos">
                ...
                <div class="modulo vermelho">
                    ...
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=tipos&file=int">Tipo Inteito</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=tipos&file=float">TipoFloat</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=tipos&file=aritimeticas">Op. Aritimeticas</a>
                        </li>
                        <li>
